...
const mapArtifact = (artifact) => {
    ...
    return {
        ...
        modality_metadata: artifact.modality_metadata || image?.modality_metadata || {},
...
export const createSubmission = async ({
    ...
    const fields = {
        ...
        modality_metadata: modalityMetadata ? (typeof modalityMetadata === "string" ? modalityMetadata : JSON.stringify(modalityMetadata)) : null,
